              ...
              {[
                {
                  icon: "📧",
                  title: "Email",
                  value: "indahmudaniramadhan.160909@gmail.com",
                  description:
              ...
              <div className="p-6 rounded-2xl bg-gray-900/50 border border-gray-800/50">
                ...
                <div className="flex gap-3 flex-wrap">
                  {[
                    {
                      label: "GitHub",
                      value: "https://github.com/inindah-ges",
                    },
                    {
                      label: "Instagram",
                      value: "https://www.instagram.com/indah_.rmdhan/",
                    },
                    {
                      label: "LinkedIn",
                      value:
                        "https://www.linkedin.com/in/indah-mudani-ramadhan-920255425",
                    },
                  ].map((social) => (
                    <a
                      key={social.label}
